...
function ModalEditLink({ linkEditId, isReload, setIsReload }: IModalEditLink) {
    ...
    return (
        <div className="modal fade" id="editLinkModal" tabIndex={-1} aria-labelledby="editLinkModalLabel"

            aria-hidden="true">

            <div className="modal-dialog">
                <div className="modal-content" style={{ backgroundColor: '#1a1a1a', color: '#fff' }}>
                    <div className="modal-header">
                        <h5 className="modal-title" id="editLinkModalLabel" style={{ color: '#ffc107' }}>Sửa Link
                        </h5>
                    ...
                    <div className="modal-body">
                        <form id="editLinkForm">
                            ...
                            <div className="mb-3">
                                ...
                                <label htmlFor="editLinkName" className="form-label">Tên Link</label>
                                <input
                                    type="text"
                            ...
                            <div className="mb-3">
                                <label htmlFor="editPostId" className="form-label">ID Bài Viết</label>
                                <input
                                    type="text"
                                    className="form-control"
                                    id="editPostId"
                            ...
                            {isAdmin &&
                                <>
                                    <div className="mb-3">
                                        <label htmlFor="editLinkType" className="form-label">Loại Link</label>
                                        <select
                                            className="form-control"
                                            id="editLinkType"
                                            style={{ backgroundColor: '#333', color: '#fff', border: '1px solid #444' }}
                                    ...
                                    <div className="mb-3">
                                        <label htmlFor="editDelayTime" className="form-label">Delay Time (giây)</label>
                                        <input
                                            type="number"
                                            className="form-control"
                                            id="editDelayTime"
                    ...
                    <div className="modal-footer">
                        ...
                        <button type="button" className="btn btn-warning" onClick={() => saveEdit()}>
                            Lưu
                        </button>
