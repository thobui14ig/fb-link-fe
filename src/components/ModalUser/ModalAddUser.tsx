...
function ModalAddUser({ isReload, setIsReload }: IModalReloadProps) {
    ...
    return (
        <div className="modal fade" id="addUserModal" tabIndex={1} aria-labelledby="addUserModalLabel"
            aria-hidden="false">
            <div className="modal-dialog">
                <div className="modal-content" style={{ backgroundColor: "#1a1a1a", color: "#fff" }}>
                    <div className="modal-header">
                        <h5 className="modal-title" id="addUserModalLabel" style={{ color: '#ffc107' }}>Add New
                            User</h5>
                    ...
                    <div className="modal-body">
                        <form id="add-user-form">
                            ...
                            <div className="row mb-3">
                                <div className="col-md-6">
                                    <label htmlFor="link_start_limit" className="form-label">
                                        Link Start Limit
                                    </label>
                                    <input
                                        type="number"
                                ...
                                <div className="col-md-6">
                                    <label htmlFor="link_add_limit" className="form-label">
                                        Link Add Limit
                                    </label>
                                    <input
                                        type="number"
                            ...
                            <div className="mb-3">
                                <label htmlFor="expired_at" className="form-label">Expiration Date</label>
                                <input
                                    type="date"
                                    className="form-control"
                                    id="expired_at"
                    ...
                    <div className="modal-footer">
                        ...
                        <button type="button" className="btn btn-warning" onClick={() => handleAdd()}>Add
                            User</button>
                    </div>
                </div>
            </div>
