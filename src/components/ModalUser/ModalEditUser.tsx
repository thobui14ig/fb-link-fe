                        ...
                        <>
                            ...
                            <div className="modal-body">
                                <form id="edit-user-form">
                                    ...
                                    <div className="row mb-3">
                                        <div className="col-md-6">
                                            <label htmlFor="editLinkStartLimit" className="form-label">Link Start Limit</label>
                                            <input
                                                type="number"
                                                className="form-control"
                                        ...
                                        <div className="col-md-6">
                                            <label htmlFor="editLinkAddLimit" className="form-label">Link Add Limit</label>
                                            <input
                                                type="number"
                                                className="form-control"
                                                id="editLinkAddLimit"
                                    ...
                                    <div className="row mb-3">
                                        <div className="col-md-6">
                                            <label htmlFor="editExpiredAt" className="form-label">Expiration Date</label>
                                            <input
                                                type="date"
                                                className="form-control"
                                                id="editExpiredAt"
                                        ...
                                        <div className="col-md-6">
                                            <label htmlFor="editLevel" className="form-label">Level</label>
                                            <select
                                                className="form-control"
                                                id="editLevel"
                                                name="level"
