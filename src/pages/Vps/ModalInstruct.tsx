  ...
  return (
    ...
    >
      <section id='instruct-area'>
        ...
        <p>
          2. Nếu là VPS mới thì cài docker, nếu là VPS có sẵn thì chuyển qua
          bước 4:
        </p>
        ...
        <p>
          4. Chỉnh sửa docker-compose.yaml để thêm service, nhớ chỉnh sửa tên
          service, container_name, port(nên tăng dần và không được trùng)
        </p>
        <p>
          5. Gõ lệnh "docker-compose up -d --build" để build lại các service
        </p>
