...
function ModalEditCookie({ isReload, linkEditId, setIsReload }: IModalEditCookie) {
    ...
    return (
        <div className="modal fade" id="editCookieModal" tabIndex={-1} aria-labelledby="editCookieModalLabel" aria-hidden="true">
            <div className="modal-dialog">
                <div className="modal-content" style={{ backgroundColor: '#1a1a1a', color: '#fff' }}>
                    <div className="modal-header">
                        <h5 className="modal-title" id="editCookieModalLabel" style={{ color: '#ffc107' }}>Sửa Cookie</h5>
                    ...
                    <div className="modal-body">
                        {cookie &&
                            <form id="editCookieForm">
                                ...
                                <div className="mb-3">
                                    <label htmlFor="editCookieValue" className="form-label">Cookie Value</label>
                                    <textarea
                                ...
                                <div className="mb-3">
                                    <label htmlFor="editCookieStatus" className="form-label">Status</label>
                                    <select
                                        className="form-control"
                                        id="editCookieStatus"
                                        required
                    ...
                    <div className="modal-footer">
                        ...
                        <button type="button" className="btn btn-warning" onClick={() => saveEdit()}>Cập nhật</button>
                    </div>
                </div>
            </div>
        </div>
